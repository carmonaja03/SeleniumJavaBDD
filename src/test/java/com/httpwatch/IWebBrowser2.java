...
public interface IWebBrowser2 extends com.httpwatch.IWebBrowserApp {
  // Methods:
  /**
   * <p>
   ...
   * </p>
   * @param cmdID Mandatory com.httpwatch.OLECMDID parameter.
   * @return  Returns a value of type com.httpwatch.OLECMDF
   */

  @DISPID(501) //= 0x1f5. The runtime will prefer the VTID if present
  @VTID(53)
  com.httpwatch.OLECMDF queryStatusWB(
    com.httpwatch.OLECMDID cmdID);
   ...
   * </p>
   * @param cmdID Mandatory com.httpwatch.OLECMDID parameter.
   * @param cmdexecopt Mandatory com.httpwatch.OLECMDEXECOPT parameter.
  ...
  void execWB(
    com.httpwatch.OLECMDID cmdID,
    com.httpwatch.OLECMDEXECOPT cmdexecopt,
   ...
   * </p>
   * @return  Returns a value of type com.httpwatch.tagREADYSTATE
   */

  @DISPID(-525) //= 0xfffffdf3. The runtime will prefer the VTID if present
  @VTID(56)
  com.httpwatch.tagREADYSTATE readyState();
