...
public class GenericStepdef extends UtilMethods{
	...
	public void user_Selects_Dropdown_Value(String value, String dropdownLabel) throws Exception {
...
//	@And("User click on \"(.*)\" label by xpath")
//	public void user_click_on_Label_by_xpath(String label) throws IOException, ClassNotFoundException {
//		ExtentTest logg=null;
//			logg= logger.createNode(new GherkinKeyword("And"), "User click on "+label+" label");
...
//	}
	...
	public void enterTestInTextBoxAsPerHeaderAndValue(DataTable data) throws Exception{
	...
	public void waitForSeconds(String time) throws Exception {
		ExtentTest logg=null;
			logg= logger.createNode(new GherkinKeyword("Then"), 
	...
	public void enterTextAndPressEnter(String fieldName, String value) throws Exception {
		ExtentTest logg=null;
